    ...
    <div className="min-h-screen bg-black">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
        <div className="mb-4 sm:mb-6 md:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">Admin Profile</h1>
          <p className="text-gray-400 text-sm sm:text-base">Manage your admin account and settings</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-gray-900 rounded-xl p-3 sm:p-4 md:p-6 border border-white/10">
              <div className="mb-4 sm:mb-6">
                ...
                <p className="text-gray-400 text-xs sm:text-sm">Administrator</p>
              </div>
          ...
          <div className="lg:col-span-3">
            <div className="bg-gray-900 rounded-xl p-3 sm:p-4 md:p-6 border border-white/10">
              {activeTab === 'overview' && (
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-4 sm:mb-5 md:mb-6">Overview</h2>
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                    <div className="bg-black rounded-lg p-4 sm:p-5 md:p-6 border border-white/10">
                      <p className="text-gray-400 text-xs sm:text-sm mb-1 sm:mb-2">Total Products</p>
                      <p className="text-2xl sm:text-3xl font-bold text-white">-</p>
                    </div>
                    <div className="bg-black rounded-lg p-4 sm:p-5 md:p-6 border border-white/10">
                      <p className="text-gray-400 text-xs sm:text-sm mb-1 sm:mb-2">Total Orders</p>
                      <p className="text-2xl sm:text-3xl font-bold text-white">-</p>
                    </div>
                    <div className="bg-black rounded-lg p-4 sm:p-5 md:p-6 border border-white/10 sm:col-span-2 md:col-span-1">
                      <p className="text-gray-400 text-xs sm:text-sm mb-1 sm:mb-2">Revenue</p>
                      <p className="text-2xl sm:text-3xl font-bold text-white">-</p>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'settings' && (
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white mb-4 sm:mb-5 md:mb-6">Settings</h2>
                  <div className="space-y-3 sm:space-y-4">
                    <div className="bg-black rounded-lg p-4 sm:p-5 md:p-6 border border-white/10">
                      <h3 className="text-white font-semibold mb-1 sm:mb-2 text-sm sm:text-base">Notifications</h3>
                      <p className="text-gray-400 text-xs sm:text-sm mb-3 sm:mb-4">Manage your notification preferences</p>
